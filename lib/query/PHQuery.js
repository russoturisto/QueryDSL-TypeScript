...
var PHQuery = (function () {
    function PHQuery(iEntity, qEntity, qEntityMap, entitiesRelationPropertyMap, entitiesPropertyTypeMap) {
    ...
    PHQuery.prototype.toJSON = function () {
        ...
        for (var propertyName in this.iEntity) {
            var queryFragment = this.iEntity[propertyName];
