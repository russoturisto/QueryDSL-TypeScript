 ...
 * same JSON tree.
 */
var PouchDbQueryAllInOne = (function () {
    function PouchDbQueryAllInOne(entityName, entitiesRelationPropertyMap, entitiesPropertyTypeMap, queryJson) {
        this.entityName = entityName;
    ...
    PouchDbQueryAllInOne.prototype.parse = function () {
        ...
        this.extractSelectFields(this.queryJson);
    ...
    PouchDbQueryAllInOne.prototype.extractSubQueries = function () {
        ...
        for (var propertyName in this.queryJson) {
            ...
            if (relationRecord) {
                ...
                var childQuery = new PouchDbQueryAllInOne(relationRecord.entityName, this.entitiesRelationPropertyMap, this.entitiesPropertyTypeMap, fragmentJson);
                this.childQueries[propertyName] = childQuery;
                delete this.queryJson[propertyName];
            }
        }
    };
    PouchDbQueryAllInOne.prototype.addField = function (fieldName) {
    ...
    PouchDbQueryAllInOne.prototype.extractJoinFields = function () {
    ...
    PouchDbQueryAllInOne.prototype.extractJoinField = function (fieldName, fragment) {
        var _this = this;
        var joinField;
    ...
    PouchDbQueryAllInOne.prototype.extractSelectFields = function (queryJson) {
        var entityPropertyTypeMap = this.entitiesPropertyTypeMap[this.entityName];
    ...
    PouchDbQueryAllInOne.prototype.extractFieldOperators = function () {
        var entityPropertyTypeMap = this.entitiesPropertyTypeMap[this.entityName];
        for (var propertyName in this.queryJson) {
            if (entityPropertyTypeMap[propertyName]) {
     ...
     */
    PouchDbQueryAllInOne.prototype.flipFieldOperators = function (fieldName, fragment) {
        var _this = this;
        var operators = [];
    ...
    return PouchDbQueryAllInOne;
}());
exports.PouchDbQueryAllInOne = PouchDbQueryAllInOne;
//# sourceMappingURL=PouchDbQueryAllInOne.js.map