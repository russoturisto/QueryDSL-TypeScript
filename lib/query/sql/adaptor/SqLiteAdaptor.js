...
var SqLiteAdaptor = (function () {
    ...
    SqLiteAdaptor.prototype.getParameterReference = function (parameterReferences, newReference) {
        return '?';
    };
    ...
    SqLiteAdaptor.prototype.getOffsetFragment = function (offset) {
        return "\nOFFSET\n\t" + offset;
    };
    SqLiteAdaptor.prototype.getLimitFragment = function (limit) {
        return "\nLIMIT\n\t" + limit;
    };
