...
var AbstractFunctionAdaptor = (function () {
    ...
    AbstractFunctionAdaptor.prototype.getFunctionCalls = function (clause, innerValue, qEntityMapByAlias, embedParameters, parameters) {
        var _this = this;
        if (embedParameters === void 0) { embedParameters = true; }
        if (parameters === void 0) { parameters = null; }
        clause.__appliedFunctions__.forEach(function (appliedFunction) {
            innerValue = _this.getFunctionCall(appliedFunction, innerValue, qEntityMapByAlias, embedParameters, parameters);
        });
        return innerValue;
    };
