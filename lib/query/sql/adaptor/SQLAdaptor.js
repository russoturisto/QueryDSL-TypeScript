...
var AbstractFunctionAdaptor = (function () {
    ...
    AbstractFunctionAdaptor.prototype.getFunctionCalls = function (clause, innerValue, qEntityMapByAlias) {
        var _this = this;
        clause.__appliedFunctions__.forEach(function (appliedFunction) {
            innerValue = _this.getFunctionCall(appliedFunction, innerValue, qEntityMapByAlias);
        });
        return innerValue;
    };
