 ...
 */
var HierachicyTracker = (function () {
    function HierachicyTracker() {
        this.currentRowObjectMap = {};
        this.objectEqualityMap = {};
        this.lastRowObjectMap = {};
        this.currentObjectOneToManys = {};
    }
    HierachicyTracker.prototype.addEntity = function (entityAlias, resultObject) {
        this.currentRowObjectMap[entityAlias] = resultObject;
    };
    HierachicyTracker.prototype.addProperty = function (entityAlias, resultObject, dataType, propertyName) {
    ...
    HierachicyTracker.prototype.addManyToOneReference = function (entityAlias, resultObject, propertyName, manyToOneIdField) {
        if (this.isDifferentOrDoesntExist(entityAlias, resultObject, propertyName)) {
            return;
        }
    ...
    HierachicyTracker.prototype.addManyToOneObject = function (entityAlias, resultObject, propertyName) {
        if (this.isDifferentOrDoesntExist(entityAlias, resultObject, propertyName)) {
            return;
        }
        var lastObject = this.lastRowObjectMap[entityAlias];
    ...
    HierachicyTracker.prototype.addOneToManyCollection = function (entityAlias, resultObject, propertyName) {
    ...
    HierachicyTracker.prototype.isDifferentOrDoesntExist = function (entityAlias, resultObject, propertyName) {
    ...
    HierachicyTracker.prototype.mergeEntity = function (entityAlias, resultObject) {
    ...
    HierachicyTracker.prototype.flushRow = function () {
        this.lastRowObjectMap = this.currentRowObjectMap;
        this.currentRowObjectMap = {};
    };
    return HierachicyTracker;
}());
exports.HierachicyTracker = HierachicyTracker;
//# sourceMappingURL=HierachicalQueryObjectTracker.js.map