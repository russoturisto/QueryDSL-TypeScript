...
var NonEntitySQLStringQuery = (function (_super) {
    ...
    NonEntitySQLStringQuery.prototype.addFieldsToView = function (viewJoinRelation, viewAlias) {
        var view = new Entity_1.QView(viewJoinRelation.rootEntityPrefix, viewJoinRelation.fromClausePosition, null);
        ...
        if (!parentTree) {
            switch (currentRelation.relationType) {
                ...
                case Relation_1.JSONRelationType.SUB_QUERY_ROOT:
                    ...
                    var subQuery = new MappedSQLStringQuery_1.MappedSQLStringQuery(viewRelation.subQuery, this.qEntityMapByName, this.entitiesRelationPropertyMap, this.entitiesPropertyTypeMap, this.dialect, this.queryResultType);
