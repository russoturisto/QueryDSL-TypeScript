...
var NonEntitySQLStringQuery = (function (_super) {
    ...
    NonEntitySQLStringQuery.prototype.copyQEntityMapByAlias = function (sourceMap, targetMap) {
    ...
    NonEntitySQLStringQuery.prototype.getValue = function (rawValue, allowField, allowSubqueries) {
    };
    NonEntitySQLStringQuery.prototype.getFieldValue = function (value, selectSqlFragment, allowNestedObjects, defaultCallback) {
        var columnName;
        var columnSelect;
        switch (value.type) {
            ...
            case Appliable_1.JSONClauseObjectType.FIELD:
                var qEntity = this.qEntityMapByAlias[value.tableAlias];
