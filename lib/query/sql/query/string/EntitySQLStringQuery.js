...
var IEntityResultParser_1 = require("../result/entity/IEntityResultParser");
...
var EntityOrderByParser_1 = require("../orderBy/EntityOrderByParser");
...
var EntitySQLStringQuery = (function (_super) {
    ...
    function EntitySQLStringQuery(rootQEntity, phJsonQuery, qEntityMapByName, entitiesRelationPropertyMap, entitiesPropertyTypeMap, dialect, queryResultType, bridgedQueryConfiguration) {
        ...
        this.columnAliases = new Aliases_1.AliasCache();
        ...
        this.orderByParser = new EntityOrderByParser_1.EntityOrderByParser(phJsonQuery.select, qEntityMapByName, entitiesRelationPropertyMap, entitiesPropertyTypeMap, this.validator, phJsonQuery.orderBy);
    }
    EntitySQLStringQuery.prototype.toSQL = function () {
        ...
        var fromFragment = this.getFROMFragment(null, this.joinTree);
        var whereFragment = '';
        ...
        for (var propertyName in selectClauseFragment) {
            ...
            if (entityPropertyTypeMap[propertyName]) {
                ...
                if (field instanceof BooleanField_1.QBooleanField) {
                    dataType = Appliable_1.SQLDataType.BOOLEAN;
                }
                else if (field instanceof DateField_1.QDateField) {
                    dataType = Appliable_1.SQLDataType.DATE;
                }
                else if (field instanceof NumberField_1.QNumberField) {
                    dataType = Appliable_1.SQLDataType.NUMBER;
                }
                else if (field instanceof StringField_1.QStringField) {
                    dataType = Appliable_1.SQLDataType.STRING;
                }
                ...
                if (childSelectClauseFragment === null) {
                    if (entityMetadata.manyToOneMap[propertyName]) {
                        ...
                        var columnAlias = this.columnAliases.getFollowingAlias();
                        var relatedEntityId = this.sqlAdaptor.getResultCellValue(resultRow, columnAlias, nextFieldIndex[0], Appliable_1.SQLDataType.NUMBER, null);
