...
var IEntityOrderByParser_1 = require("./IEntityOrderByParser");
 ...
 */
var EntityOrderByParser = (function (_super) {
    __extends(EntityOrderByParser, _super);
    function EntityOrderByParser() {
     ...
     * @returns {string}
     */
    EntityOrderByParser.prototype.getOrderByFragment = function (joinTree, qEntityMapByAlias) {
        var _this = this;
        ...
        var _loop_1 = function() {
            ...
            orderBy = orderBy.filter(function (orderByField) {
                ...
                var fieldAliasFragments = orderByField.fieldAlias.split('.');
                var orderByEntityName = fieldAliasFragments[0];
                var orderByPropertyName = fieldAliasFragments[1];
                ...
                _this.validator.validateReadProperty(orderByPropertyName, orderByEntityName);
            ...
            var entityOrderByFragments = this_1.buildOrderByFragmentForEntity(tableAlias, propertyNamesToSortBy, manyToOneRelationNamesToSortBy, idColumnToSortBy, currentEntityOrderBy, qEntityMapByAlias);
    ...
    EntityOrderByParser.prototype.buildOrderByFragmentForEntity = function (tableAlias, propertyNamesToSortBy, manyToOneRelationNamesToSortBy, idColumnToSortBy, currentEntityOrderBy, qEntityMapByAlias) {
    ...
    EntityOrderByParser.prototype.isForParentNode = function (joinTreeNode, orderByField) {
        do {
    ...
    return EntityOrderByParser;
}(IEntityOrderByParser_1.AbstractEntityOrderByParser));
