...
var SQLStringUpdate = (function (_super) {
    ...
    SQLStringUpdate.prototype.toSQL = function (embedParameters, parameters) {
        ...
        var whereFragment = this.getWHEREFragment(this.phJsonUpdate.where, 0, joinNodeMap);
        return "update\n" + updateFragment + "\nSET\n" + setFragment + "\nWHERE\n" + whereFragment;
    };
        ...
        for (var propertyName in setClauseFragment) {
            ...
            if (entityPropertyTypeMap[propertyName]) {
                ...
                if (entityMetadata.manyToOneMap[propertyName]) {
                    ...
                    var relationField = relationGenericQEntity.__entityFieldMap__[relationEntityMetadata.idProperty];
    ...
    SQLStringUpdate.prototype.getSetPropertyColumnName = function (qEntity, propertyName) {
        var entityMetadata = qEntity.__entityConstructor__;
        return MetadataUtils_1.MetadataUtils.getPropertyColumnName(propertyName, entityMetadata);
    };
    SQLStringUpdate.prototype.getSetValueFragment = function (value, entityName, propertyName, typeCheckFunction, conversionFunction) {
