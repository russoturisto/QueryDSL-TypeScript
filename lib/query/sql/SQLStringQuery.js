...
var SQLStringQuery = (function (_super) {
    ...
    SQLStringQuery.prototype.getSimpleColumnSelectFragment = function (propertyName, tableAlias, columnName, existingSelectFragment) {
    ...
    SQLStringQuery.prototype.getComplexColumnSelectFragment = function (value, columnName, existingSelectFragment) {
        var columnAlias = this.columnAliases.addAlias(value.tableAlias, value.propertyName);
        ...
        var columnSelect = selectSqlFragment + " as " + columnAlias + "\n";
        if (existingSelectFragment) {
            columnSelect = "\t, " + columnSelect;
        }
        else {
