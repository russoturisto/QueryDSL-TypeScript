...
var SQLStringQuery = (function (_super) {
    ...
    SQLStringQuery.prototype.getSimpleColumnFragment = function (value, columnName) {
        return value.tableAlias + "." + columnName;
    };
    SQLStringQuery.prototype.getComplexColumnFragment = function (value, columnName) {
    ...
    SQLStringQuery.prototype.isPrimitive = function (value) {
    ...
    SQLStringQuery.prototype.parsePrimitive = function (primitiveValue) {
