...
var SQLStringQuery = (function (_super) {
    ...
    function SQLStringQuery(phJsonQuery, qEntity, qEntityMap, entitiesRelationPropertyMap, entitiesPropertyTypeMap, dialect) {
        ...
        _this.columnAliasMap = {};
        _this.defaultsMap = {};
        _this.currentFieldIndex = 0;
        return _this;
    }
    ...
    SQLStringQuery.prototype.parseQueryResults = function (results) {
        ...
        return results.map(function (result) {
            return _this.parseQueryResult(_this.qEntity.__entityName__, _this.phJsonQuery.select, result, [0], _this.defaultsMap, entityMap);
        });
    };
    SQLStringQuery.prototype.parseQueryResult = function (entityName, selectClauseFragment, resultRow, nextFieldIndex, entityDefaultsMap, entityMap) {
        ...
        for (var propertyName in selectClauseFragment) {
            ...
            if (entityPropertyTypeMap[propertyName]) {
                ...
                if (childSelectClauseFragment == null) {
                    ...
                    var childResultObject = this.parseQueryResult(childEntityName, childSelectClauseFragment, resultRow, nextFieldIndex, childDefaultsMap, entityMap);
