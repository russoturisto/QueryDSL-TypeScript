...
var QueryLinker = (function () {
    ...
    QueryLinker.prototype.deDuplicate = function (qEntity, selectClauseFragment, parsedResults) {
    ...
    QueryLinker.prototype.mergeEntities = function (source, target) {
        if (!target) {
            return source;
        }
        for (var propertyName in qEntity.__entityRelationMap__) {
    ...
    QueryLinker.prototype.deDuplicateCollection = function () {
    };
    return QueryLinker;
}());
