...
var ObjectSQLStringQuery = (function (_super) {
    ...
    function ObjectSQLStringQuery(phJsonQuery, qEntity, qEntityMapByName, entitiesRelationPropertyMap, entitiesPropertyTypeMap, dialect, queryResultType, bridgedQueryConfiguration) {
        var _this = _super.call(this, phJsonQuery, qEntity, qEntityMapByName, entitiesRelationPropertyMap, entitiesPropertyTypeMap, dialect, queryResultType) || this;
        _this.bridgedQueryConfiguration = bridgedQueryConfiguration;
        if (bridgedQueryConfiguration && _this.bridgedQueryConfiguration.strict !== undefined) {
    ...
    ObjectSQLStringQuery.prototype.parseQueryResults = function (results) {
        var _this = this;
        this.queryParser = IQueryParser_1.getObjectQueryParser(this.queryResultType, this.bridgedQueryConfiguration, this.rootQEntity, this.qEntityMapByName);
        var parsedResults = [];
