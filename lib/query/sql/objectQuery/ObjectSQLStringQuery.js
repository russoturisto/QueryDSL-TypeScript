...
var IQueryParser_1 = require("./resultParser/IQueryParser");
...
var ObjectSQLStringQuery = (function (_super) {
    ...
    ObjectSQLStringQuery.prototype.parseQueryResults = function (results) {
        var _this = this;
        this.queryParser = IQueryParser_1.getObjectQueryParser(this.queryResultType, this.bridgedQueryConfiguration, this.qEntity, this.qEntityMap);
        var parsedResults = [];
        ...
        results.forEach(function (result) {
            ...
            var parsedResult = _this.parseQueryResult(null, null, _this.qEntity.__entityName__, _this.phJsonQuery.select, entityAlias, _this.joinTree, result, [0]);
            if (!lastResult) {
    ...
    ObjectSQLStringQuery.prototype.parseQueryResult = function (parentEntityName, parentPropertyName, entityName, selectClauseFragment, entityAlias, currentJoinNode, resultRow, nextFieldIndex) {
        ...
        for (var propertyName in selectClauseFragment) {
            ...
            if (entityPropertyTypeMap[propertyName]) {
                ...
                if (childSelectClauseFragment == null) {
                    ...
                    var childResultObject = this.parseQueryResult(entityName, propertyName, childEntityName, childSelectClauseFragment, childEntityAlias, childJoinNode, resultRow, nextFieldIndex);
                    if (entityMetadata.manyToOneMap[propertyName]) {
