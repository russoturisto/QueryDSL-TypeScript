...
var BridgedQueryParser = (function (_super) {
    ...
    function BridgedQueryParser(config, rootQEntity, qEntityMapByName) {
        var _this = _super.call(this) || this;
        _this.config = config;
        _this.rootQEntity = rootQEntity;
        _this.qEntityMapByName = qEntityMapByName;
        // Keys can only be strings or numbers | TODO: change to JS Maps, if needed
        _this.entityMapByName = {};
        _this.otmMapper = new BridgedOtmMapper_1.BridgedOtmMapper();
        _this.mtoMapper = new BridgedMtoMapper_1.BridgedMtoMapper();
        // One-To-Many & MtO temp stubs (before entityId is available)
        _this.otmStubBuffer = [];
        _this.mtoStubBuffer = [];
        // Used in RAW queries
        _this.currentResultRow = [];
        return _this;
    }
    ...
    BridgedQueryParser.prototype.bufferManyToOneStub = function (entityAlias, qEntity, entityMetadata, resultObject, propertyName, relationGenericQEntity, relationEntityMetadata, relatedEntityId) {
    ...
    BridgedQueryParser.prototype.bufferBlankManyToOneStub = function (entityAlias, resultObject, propertyName, relationEntityMetadata) {
    ...
    BridgedQueryParser.prototype.bufferManyToOne = function (entityName, propertyName, relationGenericQEntity, relationEntityMetadata, relatedEntityId) {
        var otmEntityField;
    ...
    BridgedQueryParser.prototype.getEntityToFlush = function (qEntity, selectClauseFragment, entityPropertyTypeMap, entityRelationMap, entityId, resultObject) {
