...
var BridgedOtmMapper = (function () {
    function BridgedOtmMapper() {
    ...
    BridgedOtmMapper.prototype.addMtoReference = function (mtoStubReference, mtoEntityId) {
    ...
    BridgedOtmMapper.prototype.addOtmReference = function (otmStubReference, otmEntityId) {
    ...
    BridgedOtmMapper.prototype.populateOtms = function (entityMap, keepMappedEntityArrays) {
    ...
    return BridgedOtmMapper;
}());
exports.BridgedOtmMapper = BridgedOtmMapper;
//# sourceMappingURL=BridgedOtmMapper.js.map