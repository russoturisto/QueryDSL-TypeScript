...
var QEntity = (function () {
    ...
    QEntity.prototype.addOneRelation = function (otherEntityConstructor, foreignKeyProperty) {
        var relation = new Relation_1.QRelation(otherEntityConstructor, foreignKeyProperty, Relation_1.QRelationType.ONE_TO_MANY);
        this.relations.push(relation);
    };
    QEntity.prototype.addManyRelation = function (otherEntityConstructor, manyCollectionProperty) {
        var relation = new Relation_1.QRelation(otherEntityConstructor, manyCollectionProperty, Relation_1.QRelationType.MANY_TO_ONE);
        this.relations.push(relation);
    };
