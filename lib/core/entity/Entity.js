...
var QEntity = (function () {
    ...
    QEntity.prototype.addOneRelation = function (otherEntity, foreignKeyProperty) {
        var relation = new Relation_1.QRelation(otherEntity, foreignKeyProperty);
        this.relations.push(relation);
    };
    QEntity.prototype.addManyRelation = function (otherEntity) {
        var relation = new Relation_1.QRelation(otherEntity);
        this.relations.push(relation);
    };
