...
var QEntity = (function () {
    ...
    QEntity.prototype.addOneRelation = function (foreignKeyProperty, otherEntityConstructor, otherQEnitity) {
        var relation = new Relation_1.QRelation(foreignKeyProperty, Relation_1.QRelationType.ONE_TO_MANY, otherEntityConstructor, otherQEnitity);
        this.relations.push(relation);
    };
    QEntity.prototype.addManyRelation = function (manyCollectionProperty, otherEntityConstructor, otherQEnitity) {
        var relation = new Relation_1.QRelation(manyCollectionProperty, Relation_1.QRelationType.MANY_TO_ONE, otherEntityConstructor, otherQEnitity);
        this.relations.push(relation);
    };
