...
var QEntity = (function () {
    ...
    QEntity.prototype.addOneRelation = function (otherEntityConstructor, foreignKeyProperty) {
        var relation = new Relation_1.QRelation(otherEntityConstructor, foreignKeyProperty);
        this.relations.push(relation);
    };
    QEntity.prototype.addManyRelation = function (otherEntityConstructor) {
        var relation = new Relation_1.QRelation(otherEntityConstructor);
        this.relations.push(relation);
    };
