...
var EntityAliases = (function (_super) {
    ...
    function EntityAliases(entityAliasCache, columnAliasCache, parameterAliasCache) {
        if (entityAliasCache === void 0) { entityAliasCache = new AliasCache('E'); }
        if (columnAliasCache === void 0) { columnAliasCache = new AliasCache('C'); }
        if (parameterAliasCache === void 0) { parameterAliasCache = new AliasCache('P'); }
    ...
    EntityAliases.prototype.getParams = function () {
...
var ParameterAliases = (function (_super) {
    __extends(ParameterAliases, _super);
    function ParameterAliases(aliasCache) {
        _super.call(this, aliasCache);
    }
    ParameterAliases.prototype.getNextAlias = function (object) {
        if (!this.hasAliasFor(object)) {
    ...
    ParameterAliases.prototype.getExistingAlias = function (field) {
