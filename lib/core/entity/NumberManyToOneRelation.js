...
var NUMBER_MANY_TO_ONE_ALIASES = new Aliases_1.ColumnAliases('nmp_');
var NUMBER_ENTITY_MANY_TO_ONE_ALIASES = new Aliases_1.ColumnAliases('nme_');
var QNumberManyToOneRelation = (function (_super) {
    __extends(QNumberManyToOneRelation, _super);
    function QNumberManyToOneRelation(q, qConstructor, entityName, fieldName, relationEntityConstructor, relationQEntityConstructor, alias) {
        if (alias === void 0) { alias = NUMBER_ENTITY_MANY_TO_ONE_ALIASES.getNextAlias(); }
    ...
    QNumberManyToOneRelation.prototype.getInstance = function () {
