import { ColumnConfiguration, ManyToOneElements, OneToManyElements, JoinColumnConfiguration } from "./metadata/ColumnDecorators";
...
export interface EntityMetadata {
    ...
    manyToOneMap: {
        [propertyName: string]: ManyToOneElements;
    };
    oneToManyMap: {
