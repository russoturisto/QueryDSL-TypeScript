...
var ComparisonOperation = (function (_super) {
    ...
    function ComparisonOperation(owningEntity, fieldType, fieldName, nativeFieldName, type) {
    ...
    ComparisonOperation.prototype.getDefinedInstance = function (type) {
        ...
        var definedOperation = new ComparisonOperation(this.q, this.fieldType, this.fieldName, this.nativeFieldName, type);
