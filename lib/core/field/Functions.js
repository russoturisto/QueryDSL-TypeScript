...
function abs(numberField) {
    if (typeof numberField === "number") {
        return new NumberField_1.QNumberFunction(numberField).applySqlFunction(getSqlFunctionCall(SqlFunction.ABS, true, []));
    }
    else {
...
function ucase(stringField) {
    if (typeof stringField === "string") {
        return new StringField_1.QStringFunction(stringField).applySqlFunction(getSqlFunctionCall(SqlFunction.UCASE, true, []));
    }
    else {
...
function lcase(stringField) {
    if (typeof stringField === "string") {
        return new StringField_1.QStringFunction(stringField).applySqlFunction(getSqlFunctionCall(SqlFunction.LCASE, true, []));
    }
    else {
...
function len(stringField) {
    if (typeof stringField === "string") {
        return new StringField_1.QStringFunction(stringField).applySqlFunction(getSqlFunctionCall(SqlFunction.LEN, true, []));
    }
    else {
...
function round(numberField, digits) {
    ...
    if (typeof numberField === "number") {
        return new NumberField_1.QNumberFunction(numberField).applySqlFunction(getSqlFunctionCall(SqlFunction.ROUND, true, [digits]));
    }
    else {
...
function format(format) {
    ...
    var allParams = formatParameters.slice();
    allParams.unshift(format);
    return new StringField_1.QStringFunction().applySqlFunction(getSqlFunctionCall(SqlFunction.FORMAT, true, allParams));
}
exports.format = format;
function replace(stringField, toReplace, replaceWith) {
    if (typeof stringField === "string") {
        return new StringField_1.QStringFunction(stringField).applySqlFunction(getSqlFunctionCall(SqlFunction.REPLACE, true, [toReplace, replaceWith]));
    }
    else {
...
function trim(stringField) {
    if (stringField instanceof StringField_1.QStringField) {
        ...
        return new StringField_1.QStringFunction(stringField).applySqlFunction(getSqlFunctionCall(SqlFunction.TRIM, true, []));
    }
}
exports.trim = trim;
