...
function avg(numberField) {
    if (numberField instanceof NumberField_1.QNumberField) {
    ...
    function sum(numberField) {
        ...
        function ucase(stringField) {
            if (stringField instanceof StringField_1.QStringField) {
                ...
                return new StringField_1.QStringFunction(stringField).applySqlFunction(getSqlFunctionCall(SqlFunction.UCASE, []));
            }
        }
        exports.ucase = ucase;
