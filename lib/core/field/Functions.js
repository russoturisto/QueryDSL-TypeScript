...
function abs(appliable) {
    if (typeof appliable === "number") {
        return new NumberField_1.QNumberFunction().applySqlFunction(getSqlFunctionCall(SqlFunction.ABS, true, [appliable]));
    }
    else {
...
var QDistinctFunction = (function () {
    ...
    QDistinctFunction.prototype.toJSON = function () {
        return {
...
var QExistsFunction = (function () {
    ...
    QExistsFunction.prototype.toJSON = function () {
        return {
            __appliedFunctions__: this.__appliedFunctions__,
