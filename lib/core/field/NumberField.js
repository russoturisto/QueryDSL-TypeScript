...
var QNumberField = (function (_super) {
    ...
    QNumberField.prototype.greaterThan = function (value) {
        return this.setOperation(this.operation.greaterThan(value));
    };
    QNumberField.prototype.greaterThanOrEquals = function (value) {
        return this.setOperation(this.operation.greaterThanOrEquals(value));
    };
    QNumberField.prototype.lessThan = function (value) {
        return this.setOperation(this.operation.lessThan(value));
    };
    QNumberField.prototype.lessThanOrEquals = function (value) {
