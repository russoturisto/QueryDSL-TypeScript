...
var QOperableField = (function (_super) {
    ...
    QOperableField.prototype.equals = function (value) {
        return this.operation.equals(this, QOperableField.wrapPrimitive(value));
    };
    QOperableField.prototype.greaterThan = function (value) {
        return this.operation.greaterThan(this, QOperableField.wrapPrimitive(value));
    };
    QOperableField.prototype.greaterThanOrEquals = function (value) {
        return this.operation.greaterThanOrEquals(this, QOperableField.wrapPrimitive(value));
    };
    ...
    QOperableField.prototype.isIn = function (values) {
        return this.operation.isIn(this, QOperableField.wrapPrimitive(values));
    };
    QOperableField.prototype.lessThan = function (value) {
        return this.operation.lessThan(this, QOperableField.wrapPrimitive(value));
    };
    QOperableField.prototype.lessThanOrEquals = function (value) {
        return this.operation.lessThanOrEquals(this, QOperableField.wrapPrimitive(value));
    };
    QOperableField.prototype.notEquals = function (value) {
        return this.operation.notEquals(this, QOperableField.wrapPrimitive(value));
    };
    QOperableField.prototype.notIn = function (values) {
        return this.operation.notIn(this, QOperableField.wrapPrimitive(values));
    };
    QOperableField.wrapPrimitive = function (value) {
        switch (typeof value) {
            case "boolean":
