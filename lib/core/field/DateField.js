...
var QDateFunction = (function (_super) {
    ...
    QDateFunction.prototype.toJSON = function (columnAliases) {
        return this.operableFunctionToJson(Appliable_1.JSONClauseObjectType.DATE_FIELD_FUNCTION, this.value, columnAliases);
    };
