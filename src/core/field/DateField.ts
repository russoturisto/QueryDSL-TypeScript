...
export class QDateField<IQ extends IQEntity> extends QOperableField<IQ, Date, JSONRawDateOperation<IQ>, IDateOperation<IQ>, IQDateField<IQ>> implements IQDateField<IQ> {
