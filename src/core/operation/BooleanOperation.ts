...
extends IValueOperation<JSONRawBooleanOperation, IQBooleanField> {
}

export class BooleanOperation<IQ extends IQEntity>
extends ValueOperation<JSONRawBooleanOperation, IQBooleanField> implements IBooleanOperation {
